...
public class CozinhaController {
	...
	public Page<CozinhaModel> listar(@PageableDefault(size = 10) Pageable pageable){
		...
		List<CozinhaModel> cozinhasModel = cozinhaModelConverter.toCollectionModel(cozinhaPageable.getContent());

		Page<CozinhaModel> cozinhaModelPage = new PageImpl<>(cozinhasModel, pageable, cozinhaPageable.getTotalElements());
